...
public class TwistView extends View {
	...
	private static final float AUTO_AREA_BUTTOM_RIGHT = 1 / 2F, AUTO_AREA_BUTTOM_LEFT = 1 / 8F;// 右下角和左侧自滑区域占比
	private static final float AUTO_SLIDE_BL_V = 1 / 10F, AUTO_SLIDE_BR_V = 1 / 10F;// 滑动速度占比
	...
	private int mSubWidthStart, mSubWidthEnd, mSubHeightStart, mSubHeightEnd;// 扭曲细分线的下标
	...
	private float mSubMinWidth, mSubMinHeight;// 最小细分宽高

	private float[] mVerts;// 变换坐标点
